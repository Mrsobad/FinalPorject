...
{
	AFInalProjectACharacter* Character = Cast<AFInalProjectACharacter>(OtherActor);
	if (Character)
	{
		if (otherPortal)
		{
			if (!Character->isTeleporting)
			{
				...
				TimerDelegate.BindUFunction(this, "SetBool", Character);
...
void APortal::SetBool(AFInalProjectACharacter* character)
{
	if (character)
	{
